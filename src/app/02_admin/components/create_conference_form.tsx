...
const Create_Form = () => {
  ...
  useEffect(() => {
    const total = 3; // change this to however many images you saved
    const files = Array.from({ length: total }, (_, i) => 
      `/images/conference_images/image_${i + 1}.png` // filenames start at 1
    );
    setImages(files);
  }, []);
  ...
  return (
    <div className="create_form_container">
      ...
      <div className="text_area">
        ...
        <TextInput value={current_attendees} setValue={setCurrent_attendees} placeholder={'Current Attendees'}/>
